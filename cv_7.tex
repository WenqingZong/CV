...
\item Responsiable for backend API development in Rust, transforming AI models trained by the research team into market-ready products, while employing innovative Rust libraries to minimize API response times.
...
\cvitem{Languages}{Rust, Python, Java, C, JavaScript, familiar with C++}
\cvitem{Frameworks}{Tokio, Ndarray, PyTorch, Spring, OpenGL, Flask, JUnit}
\cvitem{Utilities}{Linux, Docker, Ansible, Git, Markdown, LaTeX, CI/CD, OpenQA, AWS, Azure}
\cvitem{Communication}{English(fluent), Chinese(mother language)}


\section{Projects}

\cventry{Jun 2024 - Present}{Rust Voice Acativity Detection Library}{}{\href{https://crates.io/crates/silero_vad}{[Homepage]}}{Rust}{
\begin{itemize}
\item Ongoing personal open-source project. Published on crates.io
\item Pure Rust implementation of Silero VAD model and algorithm.
\item Easy to use batch and streaming interface.
\item Doing: Async interface. 
\end{itemize}}
