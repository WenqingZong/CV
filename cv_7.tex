...
\begin{itemize}
\item Monitor the status of more than 200 server clusters and maintain the normal operation of the database.
...
\cvitem{Utilities}{Linux, Anaconda, IDEA, Jupyter Notebook, Git, Markdown, LaTeX, Jenkins}
